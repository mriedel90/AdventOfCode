...
gyxo (61)
cntj (57)", "tknk")]
        [TestCase(puzzleInput, "gynfwly")]
        public void Day7_Part1(string input, string expectedResult)
        {
            // Arrange


            // Act
            var result = Day7.FindBottomOfTower(input);
...
gyxo (61)
cntj (57)", 60)]
        [TestCase(puzzleInput, 1526)]
        public void Day7_Part2(string input, int expectedResult)
        {
            // Arrange


            // Act
            var result = Day7.FindCorrectWeightOfOffDisk(input);
        ...
        private const string puzzleInput = @"jlbcwrl (93)
