...
totally-real-room-200[decoy]", 1514)]
        [TestCase(@"bkwzkqsxq-tovvilokx-nozvyiwoxd-172[fstek]
...
hplazytkpo-prr-cpnptgtyr-379[prtya]", 185371)]
        public void Day4_Part1(string input, int expectedResult)
        {
            ...
            // Act
            var result = Day4.SumValidSectorIds(input);
...
zhdsrqlchg-gbh-frqwdlqphqw-361[nqzts]
kyelcrga-cee-yaosgqgrgml-808[izdqr]
hplazytkpo-prr-cpnptgtyr-379[prtya]", 984)]
        public void Day4_Part2(string input, int expectedResult)
        {
            // Arrange


            // Act
            var result = Day4.GetSectorIdOfNorthPoleStorageRoom(input);
